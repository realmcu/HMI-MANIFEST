...
| RTL8773G eBadge | `mkdir <workspace> && cd <workspace> && west init -m ssh://cn4soc.rtkbf.com:29418/hmi/manifest --mr master --mf rtl8773g-eBadge.yml . && west update` | 暂未开源 | `west build -b rtl87x3g_evb zephyrproject/realtek-app/applications/eBadge` |
